...
public class SubscriptionService {
	...
	private final EmailSender emailSender;
		...
		public void delete(Subscription subcription) {
		 ...
		 private String buildEmail(String name, String formation,String date_debut,String date_fin,String Client) {
		        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
		                ...
		                "                      <span style=\"font-family:Helvetica,Arial,sans-serif;font-weight:700;color:#ffffff;text-decoration:none;vertical-align:top;display:inline-block\">Cette formation vous avez été assignée</span>\n" +
		                "                    </td>\n" +
		                "                  </tr>\n" +
		                "                </tbody></table>\n" +
		                "              </a>\n" +
		                ...
		                "        \n" +
		                "            <p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\">Bonjour " + name + ",</p><p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\"> Himaya.ma vous a assignée pour animer la formation sur " +formation+ " et qui demarera le :"+date_debut+" jusqu'a :"+date_fin+" en faveur du client :"+Client+ "</p>" +
		                "        \n" +
		                "      </td>\n" +
		                "      <td width=\"10\" valign=\"middle\"><br></td>\n" +
		                "    </tr>\n" +
